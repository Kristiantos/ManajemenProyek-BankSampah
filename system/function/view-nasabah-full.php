        ...
        <tr align="center">
            ...
            <td>
              <?php
                       ...
                       $saldoakhir = mysqli_query($conn, "UPDATE nasabah SET saldo=$tot_saldo_total WHERE nin='".$row['nin']."'");                    
              ?>                    
            ...
            <td>
              <?php 
                    ...
                    $beratakhir = mysqli_query($conn, "UPDATE nasabah SET sampah='$sampahnya' WHERE nin='".$row['nin']."'");
              ?>               
